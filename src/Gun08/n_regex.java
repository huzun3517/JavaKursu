...
public class n_regex {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("b".matches("[abc]?")); //  true a, b, c bir defa kullanilabilir
        ...
        System.out.println("* quantifier ....");
        System.out.println("abbbca".matches("[abc]*")); // true, a, b, c,  0 veya fazla olmali

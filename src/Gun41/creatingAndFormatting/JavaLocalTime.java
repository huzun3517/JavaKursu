...
public class JavaLocalTime {
    public static void main(String[] args) {
        ...
        System.out.println("SHORT Date = " + time1.format(DateTimeFormatter.ofLocalizedDate(FormatStyle.SHORT)));
        System.out.println("MEDIUM Date = " + time1.format(DateTimeFormatter.ofLocalizedDate(FormatStyle.MEDIUM)));
    }
}

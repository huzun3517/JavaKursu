...
public class Okul {
    ...
    private ArrayList<Ogrenci> ogrecileri;
    ...
    public ArrayList<Ogrenci> getOgrecileri() {
        return ogrecileri;
    }

    public void setOgrecileri(ArrayList<Ogrenci> ogrecileri) {
        this.ogrecileri = ogrecileri;
    }
